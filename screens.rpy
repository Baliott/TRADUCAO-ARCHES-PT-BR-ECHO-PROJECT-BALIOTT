...
screen say(who, what):
    style_prefix "say"
    window at textbox_anim: # Add our transform
        id "window"
        if who is not None:
...
screen navigation():
    ...
    hbox:
        ...
        if main_menu:
            textbutton _("Musica") action ShowMenu("music_room", mr=music_room)

        if persistent.goingincircles:
            textbutton _("???") action Start("keepgoing")
...
screen navigationendgame():
    ...
    hbox:
        ...
        #textbutton _("Music") action ShowMenu("music_room", mr=music_room)
...
screen main_menu():
    ...
    if persistent.goingincircles:
        use navigationendgame
    else:
        use navigation


    if persistent.shortstory1:
        imagebutton auto "gui/mm/cam_%s.png" action [Play("sound", "sounds/camtuningfin.ogg"), Start ("shortstory1")] ypos 350 xpos 772

    if persistent.shortstory2:
        imagebutton auto "gui/mm/dev_%s.png" action [Play("sound", "sounds/camtuningfin.ogg"), Start ("shortstory2")] ypos 350 xpos 950
...
style main_menu2_frame:
    xsize 420
    yfill True

    background "gui/main_menu2_frame.png"
